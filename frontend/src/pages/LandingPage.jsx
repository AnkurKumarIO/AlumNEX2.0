        ...
        <section style={{ 
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '1.5rem' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
              ...
              {/* RIGHT TOP: Target-Driven Filters */}
              <div className="glass-card" style={{ flex: 1, display: 'flex', flexDirection: 'column', justifyContent: 'space-between', minHeight: '160px', padding: 'clamp(1.25rem, 3vw, 1.75rem)', overflow: 'hidden' }}>
                <div>
                  <div style={{ display: 'flex', alignItems: 'center', gap: '0.4rem', marginBottom: '0.5rem' }}>
                    <div style={{ width: 5, height: 5, borderRadius: '50%', background: '#4edea3', boxShadow: '0 0 6px #4edea3' }}/>
                    <span style={{ fontSize: '0.55rem', fontWeight: 700, textTransform: 'uppercase', letterSpacing: '0.18em', color: '#4edea3', opacity: 0.85 }}>Match Architecture</span>
                  </div>
                  <div style={{ fontSize: 'clamp(1.1rem, 2.5vw, 1.3rem)', fontWeight: 800, color: '#fff', marginBottom: '0.6rem', letterSpacing: '-0.02em' }}>
                    Target-Driven Filters
                  </div>
                  <p style={{ fontSize: 'clamp(0.72rem, 1.8vw, 0.78rem)', color: 'rgba(199,196,216,0.75)', lineHeight: 1.6, margin: 0 }}>
                    Find the exact alumni who have already walked your dream path. Filter by target company, technical stack, or specific engineering domains to match instantly.
                  </p>
                </div>
                ...
                <div style={{ display: 'flex', flexWrap: 'wrap', gap: '0.5rem', marginTop: '1rem' }}>
                  {[
                    { label: '🏢 Target: Google',   color: '#4edea3', bg: 'rgba(78,222,163,0.1)',   border: 'rgba(78,222,163,0.25)' },
                    { label: '⚙️ Stack: C++',        color: '#c3c0ff', bg: 'rgba(195,192,255,0.1)', border: 'rgba(195,192,255,0.25)' },
                    { label: '✦ System Design',     color: '#c7c4d8', bg: 'rgba(199,196,216,0.07)', border: 'rgba(199,196,216,0.15)' },
                    { label: '🎓 Campus Alumni',    color: '#ffb95f', bg: 'rgba(255,185,95,0.1)',   border: 'rgba(255,185,95,0.25)' },
                  ].map(chip => (
              ...
              {/* RIGHT BOTTOM: 100% Vetted Ecosystem */}
              <div className="glass-card" style={{ flex: 1, minHeight: '160px', overflow: 'hidden', position: 'relative', display: 'flex', flexDirection: 'column', justifyContent: 'space-between', padding: 'clamp(1.25rem, 3vw, 1.75rem)' }}>
                <div>
                  <div style={{ display: 'flex', alignItems: 'center', gap: '0.4rem', marginBottom: '0.5rem' }}>
                    <div style={{ width: 5, height: 5, borderRadius: '50%', background: '#4edea3', boxShadow: '0 0 6px #4edea3' }}/>
                    <span style={{ fontSize: '0.55rem', fontWeight: 700, textTransform: 'uppercase', letterSpacing: '0.18em', color: '#4edea3', opacity: 0.85 }}>Trust & Security</span>
                  </div>
                  <div style={{ fontSize: 'clamp(1.1rem, 2.5vw, 1.3rem)', fontWeight: 800, color: '#fff', marginBottom: '0.6rem', letterSpacing: '-0.02em' }}>
                    100% Vetted Ecosystem
                  </div>
                  <p style={{ fontSize: 'clamp(0.72rem, 1.8vw, 0.78rem)', color: 'rgba(199,196,216,0.75)', lineHeight: 1.6, margin: 0 }}>
                    Zero spam, zero fake profiles. Every mentor on AlumNEX is manually verified through official corporate email credentials or institutional verification before onboarding.
                  </p>
                </div>
                ...
                <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', marginTop: '1.25rem' }}>
                  <div style={{ position: 'relative', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '0.5rem' }}>
                    ...
                    <svg width="64" height="72" viewBox="0 0 64 72" fill="none" xmlns="http://www.w3.org/2000/svg">
                      ...
                      {/* Outer glow */}
                      <path d="M32 4 L58 14 L58 38 Q58 58 32 68 Q6 58 6 38 L6 14 Z" fill="rgba(78,222,163,0.08)" stroke="rgba(78,222,163,0.2)" strokeWidth="1" filter="url(#shieldGlow)"/>
                      {/* Main shield */}
                      <path d="M32 8 L54 17 L54 38 Q54 55 32 64 Q10 55 10 38 L10 17 Z" fill="url(#shieldGrad)" fillOpacity="0.15" stroke="url(#shieldGrad)" strokeWidth="1.5"/>
                      {/* Checkmark */}
                      <path d="M20 36 L28 44 L44 28" stroke="#4edea3" strokeWidth="3.5" strokeLinecap="round" strokeLinejoin="round" fill="none"/>
                    </svg>
                    {/* Badge label */}
                    <div style={{
